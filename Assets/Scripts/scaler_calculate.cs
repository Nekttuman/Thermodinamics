...
public class scaler_calculate : MonoBehaviour
{
    ...
    public Material E_digit_material;
    public Material R_difit_material;
    ...
    void DisplayError()
    {
        digits[0].material = R_difit_material;
        digits[1].material = mat[0];
        digits[2].material = R_difit_material;
        digits[3].material = R_difit_material;
        digits[4].material = E_digit_material;
